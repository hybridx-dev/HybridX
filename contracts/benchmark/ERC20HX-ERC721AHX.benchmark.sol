...
contract ERC721AHXExample is ERC721AHX {
    constructor() ERC721A("ERC721AHXExample", "ERC721AHXExample") {
...
contract MockAccount is IERC721Receiver {
    ...
    function transferNFT(address hxContract, address to, uint256[] calldata ids) public {
        for (uint i = 0; i < ids.length; i++) {
            ERC721AHX(hxContract).transferFrom(address(this), to, ids[i]);
        }
    }
...
contract ERC20HXERC721AHXBenchmark {
    ERC20HXExample erc20HXExample;
    ERC721AHXExample erc721AHXExample;
    ...
    function benchmarkContractDeployment() public {
        erc721AHXExample = new ERC721AHXExample();
        erc20HXExample = new ERC20HXExample();
    }

    function benchmarkContractSetup() public {
        erc20HXExample.setNFTContract(address(erc721AHXExample));
        erc721AHXExample.setMinterRole(address(erc20HXExample));
    }
    ...
    function benchmarkTransferNFT() public {
        ...
        mockAccount0.transferNFT(address(erc721AHXExample), address(mockAccount1), ids);
    }
    ...
    function benchmarkBurn25NFTsAndTransferFT() public {
        ...
        mockAccount0.burn(address(erc20HXExample), ids);
        mockAccount0.transfer(address(erc20HXExample), address(mockAccount1), 25 * 10 ** 18);
    }
}
